...
@section('mainContent')
    <div class="box">
        <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-white" style="float:left">
            <div class="position-sticky">
                <div class="list-group list-group-flush mt-1">
                    <a href="{{ route('goto_profile') }}" class="list-group-item list-group-item-action py-2 ripple"
                        aria-current="true">
        ...
        <div class="container1">
            <h3><img src="dummy.png" alt="Avatar"
                    class="avatar"><br>{{ Auth::user()->fname }}&nbsp;{{ Auth::user()->lname }}</h3>
            <br>
            <form action="{{ route('doEditprofil') }}" method="GET">
                ...
                <pre><p> <strong>Telephone Number :</strong><input  name="telnum" type="text" value="{{ Auth::user()->notelp }}"></p></pre>
