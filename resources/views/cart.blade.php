...
<div class="box">
  <table class="table">
    ...
    <table class="table table-striped" id="itemtable">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><input type="number" id="inp" style="width: 100px" min="1" max="99" value="1"><input type="hidden" name=""
              id="" value="{{$ctr}}"></td>
    ...
    <form action="/xendit/va/list" method="GET">
      <div style="float: right"><span>Rp.</span><span id="subtotal"></span> <input type="hidden" name="total"
          id="totalharga"></div>
      @php
      session(['idbrg' => $strid]);
      @endphp
